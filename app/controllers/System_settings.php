...
class system_settings extends MY_Controller
{
    ...
    function index()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array('site_name' => $this->input->post('site_name'), //DEMO ? 'Stock Manager Advance' : $this->input->post('site_name')
                'rows_per_page' => $this->input->post('rows_per_page'),
                'dateformat' => $this->input->post('dateformat'),
                'timezone' => $this->input->post('timezone'), //DEMO ? 'Asia/Kuala_Lumpur' : $this->input->post('timezone')
                ...
                'default_email' => $this->input->post('email'), //DEMO ? 'noreply@sma.tecdiary.my' : $this->input->post('email')
                'language' => $lang,
                ...
                'protocol' => $this->input->post('protocol'), //DEMO ? 'mail' : $this->input->post('protocol')
    ...
    function permissions($id = NULL)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'reports-poscheck' => $this->input->post('reports-poscheck'),
                'reports-invoicecheck' => $this->input->post('reports-invoicecheck'),
            );
