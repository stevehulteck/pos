                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_reports">
                                ...
                                <ul>
                                    ...
                                    <li id="reports_sales">
                                        <a href="<?= site_url('reports/poscheck') ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('Pos_Check_Report'); ?></span>
                                        </a>
                                    </li>
                                    <li id="reports_sales">
                                        <a href="<?= site_url('reports/invoicecheck') ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('Invoice_Check_Report'); ?></span>
                                        </a>
                                    </li>
                        ...
                        <?php
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
                                ...
                                <ul>
                                    <li id="sales_index">
                                        <a class="submenu" href="<?= site_url('sales'); ?>">
                                            <i class="fa fa-heart"></i><span class="text"> <?= lang('List_Invoice'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="sales_add">
                                        <a class="submenu" href="<?= site_url('sales/add'); ?>">
                                            <i class="fa fa-plus-circle"></i><span class="text"> <?= lang('Add_Invoice'); ?></span>
                                        </a>
                                    </li>
                                    <?php }
                            ...
                            <?php if ($GP['reports-quantity_alerts'] || $GP['reports-expiry_alerts'] || $GP['reports-products'] || $GP['reports-monthly_sales'] || $GP['reports-sales'] || $GP['reports-payments'] || $GP['reports-purchases'] || $GP['reports-customers'] || $GP['reports-suppliers'] || $GP['reports-expenses'] || $GP['reports-poscheck'] || $GP['reports-invoicecheck']) { ?>
                            <li class="mm_reports">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-bar-chart-o"></i>
                                    <span class="text"> <?= lang('reports'); ?> </span> 
