            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("Invoice_Check_Sale", "slinvoice_check_sale"); ?><br/>
                                <?php echo form_checkbox('invoice_check_sale', 1, false, 'class="form-control tip" title="' . lang('invoice_check_sale') . '" id="slinvoice_check_sale"'); ?>
                            </div>
                        </div>    
                        <div class="clearfix"></div>
