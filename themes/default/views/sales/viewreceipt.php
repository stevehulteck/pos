...
<head>
    ...
    <title><?php echo $this->lang->line('purchase') . ' ' . str_replace("SALE", "INVOICE", $inv->reference_no); ?></title>
    ...
    <style type="text/css">
        ...
        @media print {
                ...
                #wrapper { max-width: 780px; width: 100%; min-width: 450px; margin: 0 auto; }
        ...
        <div class="col-lg-12">
            ...
            <div class="row padding10">
                ...
                <div class="col-xs-7">
                    <div class="bold">
                        ...
                        <?= lang('ref'); ?>: <?= str_replace("SALE", "INVOICE", $inv->reference_no); ?><br>
            ...
            <div class="row">
                ...
                <div class="col-xs-4  pull-left">
                    <p style="height: 80px;"><?php /*<?= lang('seller'); ?>
