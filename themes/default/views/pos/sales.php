    ...
    $(document).ready(function () {
        var oTable = $('#POSData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
				...
				$('td:eq(9) #posactions ul li:eq(3) a#pcs', nRow).each( function() {
					if($(this).attr("data-id") == 1) {
						$(this).html('<i class="fa fa-check-square-o"></i> Pos Check Sale');
					} else {
						$(this).html('<i class="fa fa-square-o"></i> Pos Check Sale');
					}
				});
                return nRow;
            },
