    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table width="100%" class="stable">
                ...
                $cashhand = 0;
                if($cash_in_hand) {
                    $cashhand = $cash_in_hand;
                } else {
                    $cashhand = $this->session->userdata('cash_in_hand');
                }
                ?>
                <tr>
                ...
                <tr>
                    <td style="border-bottom: 1px solid #DDD;"><h4><?= lang('mpesa_payment'); ?>:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                            <span><?= $this->sma->formatMoney($mpsales->paid ? $mpsales->paid : '0.00') . ' (' . $this->sma->formatMoney($mpsales->total ? $mpsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="200px;" style="font-weight:bold;text-align:right;"><h4>
                            <span><?= $this->sma->formatMoney($totalsales->paid ? ($totalsales->paid + $cashhand) : '0.00') . ' (' . $this->sma->formatMoney($totalsales->total ? ($totalsales->total + $cashhand) : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->sma->formatMoney(($cashsales->paid+$cashhand) - $expense) : $this->sma->formatMoney($this->session->userdata('cash_in_hand') - $expense); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
            ...
            <div class="row no-print">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <?= lang("Total_mpesa", "total_mpesa_submitted"); ?>
                        <?= form_hidden('total_mpesa', $mpsales->total_mpesa); ?>
                        <?= form_input('total_mpesa_submitted', (isset($_POST['total_mpesa_submitted']) ? $_POST['total_mpesa_submitted'] : $mpsales->total_mpesa), 'class="form-control input-tip" id="total_mpesa_submitted" required="required"'); ?>
                    </div>
                </div>
                <div class="col-sm-6">
