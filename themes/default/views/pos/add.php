                            ...
                            <div id="left-bottom">
                                <table id="totalTable"
                                    ...
                                    <tr>
                                        <td colspan="4" style="padding: 5px 10px;">
                                            <input type="checkbox" id="poschksale" name="poschksale" value="1"/>&nbsp; POS Check Sale
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <div id="payment-con">
                                    <?php for ($i = 1; $i <= 5; $i++) {?>
                                        ...
                                        <input type="hidden" name="mpesa_no[]" id="mpesa_no_val_<?=$i?>" value=""/>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-11">
                                            ...
                                            <div class="pmpesa_1" style="display:none;">
                                                <div class="form-group"><?=lang("mpesa No", "mpesa_1");?>
                                                    <input name="mpesa_no[]" type="text" id="mpesa_no_1"
                                                           class="form-control mpesa_no"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<?php if ($this->input->get('customer')) {?>
        ...
        $('#paymentModal').on('change', '#mpesa_no_<?=$i?>', function (e) {
            $('#mpesa_no_val_<?=$i?>').val($(this).val());
        });
