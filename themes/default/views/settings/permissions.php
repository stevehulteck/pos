                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        ...
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="poscheck" name="reports-poscheck" <?php echo $p->{'reports-poscheck'} ? "checked" : ''; ?>>
                                            <label for="poscheck" class="padding05">POS Check</label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="invoicecheck" name="reports-invoicecheck" <?php echo $p->{'reports-invoicecheck'} ? "checked" : ''; ?>>
                                            <label for="invoicecheck" class="padding05">Invoice Check</label>
                                        </span>
                                    </td>
                                </tr>
